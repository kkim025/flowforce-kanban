...
@Module({
  imports: [PrismaModule, forwardRef(() => BoardsModule), forwardRef(() => ChecklistsModule)],
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (taskRepo: ITaskRepository, boardRepo: IBoardRepository) => new CreateTaskUseCase(taskRepo, boardRepo),
      inject: ["ITaskRepository", "IBoardRepository"],
    },
    {
      provide: MoveTaskUseCase,
      useFactory: (taskRepo: ITaskRepository, boardRepo: IBoardRepository) => new MoveTaskUseCase(taskRepo, boardRepo),
      inject: ["ITaskRepository", "IBoardRepository"],
    },
    {
  ...
  exports: [TasksService, "ITaskRepository", CreateTaskUseCase, MoveTaskUseCase, UpdateSubtaskUseCase, AddChecklistUseCase],
})
