...
describe('getSortedTimeline', () => {
    it('should sort activities and comments by date (oldest first)', () => {
        const activities: Activity[] = [
            { id: '1', taskId: 't1', userId: 'u1', type: 'task_created', createdAt: '2024-01-01T10:00:00Z', details: {} },
            { id: '3', taskId: 't1', userId: 'u1', type: 'priority_change', createdAt: '2024-01-01T12:00:00Z', details: {} },
        ];
    ...
    it('should filter out activities of type "comment"', () => {
        ...
        const activities: Activity[] = [
            { id: '1', taskId: 't1', userId: 'u1', type: 'comment', createdAt: '2024-01-01T10:00:00Z', details: {} },
        ];
        const comments: Comment[] = [
